...
HOT_MARKER_ALERT = "\033[38;5;220m"           # жёлтый
HOT_MARKER_BREAKING_FLASH = "\033[48;5;196;97m"  # красный фон (мигание)
HOT_SOURCE_COLOR = "\033[38;5;244m"           # серый для источника
HOT_TITLE_COLOR = "\033[38;5;252m"            # светлый для заголовка
HOT_TIME_COLOR = "\033[38;5;240m"             # тёмно-серый для времени
...
# Глобальный флаг: включён ли перевод вообще.
# False — перевод не запускается, Google не дёргается, кэш не трогается.
...
class Color:
    ...
    ALERT = "\033[1;38;5;220m"
    BREAKING = "\033[1;48;5;196;97m"
